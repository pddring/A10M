 ...
 */
 ...
 #define REQUIRED_CONFIGURATION_ADV_H_VERSION 02010300
 //===========================================================================
 //============================= Getting Started =============================
 //===========================================================================
 ...
 #define STRING_CONFIG_H_AUTHOR                   "(pddring, Geeetech)"
 ...
 #define CUSTOM_MACHINE_NAME "Pete's Geeetech A10M"
  ...
  *     O-- FRONT --+
  */
  #define NOZZLE_TO_PROBE_OFFSET { -43, 0, -4.1 }
